...
(function () {
    ...
    c = this.WeakMap || this.MozWeakMap || (c = function () {
        ...
        return a.prototype.get = function (a) {
            var b, c, d, e, f;
            for (f = this.keys, d = c = 0, e = f.length; e > c; d = ++c)
                if (b = f[d], b === a) return this.values[d]
        }, a.prototype.set = function (a, b) {
            var c, d, e, f, g;
            for (g = this.keys, e = c = 0, f = g.length; f > e; e = ++c)
                if (d = g[e], d === a) return void (this.values[e] = b);
    ...
    this.WOW = function () {
        ...
        e.prototype.doSync = function (a) {
            ...
            if (null == a && (a = this.element), 1 === a.nodeType) {
                for (a = a.parentNode || a, e = a.querySelectorAll("." + this.config.boxClass), f = [], c = 0, d = e.length; d > c; c++) 
                    b = e[c], g.call(this.all, b) < 0 ? 
                        (this.boxes.push(b), this.all.push(b), 
        ...
        e.prototype.vendorCSS = function (a, b) {
            var c, e, f, g, h, i;
            for (h = d(a), g = h.getPropertyCSSValue(b), i = this.vendors, c = 0, e = i.length; e > c; c++) 
                f = i[c], g = g || h.getPropertyCSSValue("-" + f + "-" + b);
            return g
        }, 
        ...
        e.prototype.cacheAnimationName = function (a) {
            ...
            return c = a.getAttribute("data-wow-offset") || this.config.offset, f = window.pageYOffset,
                ...
                d = this.offsetTop(a), b = d + a.clientHeight, e >= d && b >= f
